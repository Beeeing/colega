      ...
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="mb-10 space-y-4">
          <p className="text-xl sm:text-2xl md:text-3xl font-black leading-snug">
            ...
            <span className="text-red-400">{c.title_q_highlight}</span>
          </p>
          <p className="text-xl font-bold text-gray-300">{c.or}</p>
          <p className="text-xl sm:text-2xl md:text-3xl font-black leading-snug">
            {c.title_a_pre}
            <span
        ...
        <div className="bg-gray-800 rounded-2xl p-5 sm:p-6 mb-10 border border-gray-700 text-left max-w-sm sm:max-w-xl mx-auto">
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-2 w-full sm:w-auto text-white font-bold py-4 sm:py-5 px-8 sm:px-10 rounded-full text-base shadow-xl hover:opacity-90 transition-opacity"
          style={{ background: "linear-gradient(90deg, #0ea5e9 0%, #6366f1 100%)" }}
        >
          <LineIcon className="w-6 h-6 flex-shrink-0" />
          {c.cta}
        </a>
        <p className="text-xs text-gray-500 mt-3">{c.cta_note}</p>
      </div>
    </section>
  )
}
